...
const updateProfilePage = (pageId, data) => {
    ...
    return notion.pages.update({
        ...
        properties: {
            ...
            'link_shadow_type': { select: { name: appearance.link.shadowType || 'none' } },
            'link_shadow_intensity': { number: appearance.link.shadowIntensity || 10 },
            'link_shadow_color': { rich_text: toRichText(appearance.link.shadowColor) },
            ...
            'header_shadow_type': { select: { name: appearance.header.shadowType || 'none' } },
            'header_shadow_intensity': { number: appearance.header.shadowIntensity || 10 },
            'header_shadow_color': { rich_text: toRichText(appearance.header.shadowColor) },
